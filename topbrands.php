 ...
 <div class="main">
    <div class="content">
    	...
    	<div class="content_top">
    		...
    		<div class="heading">	
    		<h3>Thương hiệu : <?php echo $result_name['Name'] ?></h3>
    		</div>
	      ...
	      <div class="section group">
	      	...
	      	?>
				<div class="grid_1_of_4 images_1_of_4">
					 <a href="details.php?proid=<?php echo $result['id'] ?>"><img src="admin/upload/<?php echo $result['image'] ?>" width="200px" alt="" /></a>
					 <h2><?php echo $result['Name'] ?></h2>
					 <p><?php echo $fm->textShorten($result['product_desc'],50); ?></p>
					 <p><span class="price"><?php echo number_format($result['price'])." "."VNĐ" ?></span></p>
				     <div class="button"><span><a href="details.php?proid=<?php echo $result['id'] ?>" class="details">Chi tiết</a></span></div>
				</div>
			<?php
			}
